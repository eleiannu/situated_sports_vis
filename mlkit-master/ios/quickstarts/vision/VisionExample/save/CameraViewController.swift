...
class CameraViewController: UIViewController, ChartViewDelegate{
    ...
    private var flagPoint2 : Bool = false
  ...
  override func viewDidLoad() {
    super.viewDidLoad()
      ...
      self.hipSMButton.titleLabel?.textColor = .black
      ...
      self.maxAngleSMButton.titleLabel?.textColor = .black
      ...
      self.strokeRateGraphLabel.isHidden = true
      self.timesGraphLabel.isHidden = true
      self.timesGraphLabel.text = "Time per stroke"
      self.strokeRateGraphLabel.text = "Stroke Rate"
      ...
      self.timesGraphLabel.layer.cornerRadius = 8.0
      self.timesGraphLabel.clipsToBounds = true
      self.strokeRateGraphLabel.layer.cornerRadius = 8.0
      self.strokeRateGraphLabel.clipsToBounds = true
      ...
      self.timesGraphLabel.backgroundColor = UIColor(red:255.0/255.0, green:255.0/255.0, blue:255.0/255.0, alpha:0.9)
      self.strokeRateGraphLabel.backgroundColor = UIColor(red:255.0/255.0, green:255.0/255.0, blue:255.0/255.0, alpha:0.9)
      timesGraphLabel.font = UIFont(name: "Avenir", size: 18)
      strokeRateGraphLabel.font = UIFont(name: "Avenir", size: 18)
      ...
      isRecordingLabel.textColor = .black
    ...
    func addGesture() {
       ...
       func labelTapped(_ tap: UITapGestureRecognizer) {
           ...
           self.timesGraphLabel.isHidden = !self.timesGraphLabel.isHidden
    ...
    func addGesture3() {
       ...
       func labelTapped2(_ tap: UITapGestureRecognizer) {
           ...
           self.strokeRateGraphLabel.isHidden = !self.strokeRateGraphLabel.isHidden
           self.strokeRateLabel.isHidden = !self.strokeRateLabel.isHidden
       }
  ...
  func maxAngleLabelTapped(_ tap: UITapGestureRecognizer) {
    ...
    func showEverything(){
        ...
        anglesGraph.isHidden = true
        moveLabel(label: elbowLabel, x: 235, y: 68)
        moveLabel(label: elbowLabelLong, x: 235, y: 114)
        moveButton(button: elbowSMButton, x: 235, y: 183)
        moveLabel(label: hipLabel, x: 428, y: 68)
        moveLabel(label: hipLabelLong, x: 428, y: 114)
        moveButton(button: hipSMButton, x: 428, y: 183)
  ...
  @IBAction func recordVideo(_ sender: Any) {
    ...
    @IBAction func showMoreElbow(_ sender: Any) {
        if elbowGraph.isHidden {
            ...
            moveLabel(label: elbowLabel, x: 42, y: 68)
            moveLabel(label: elbowLabelLong, x: 42, y: 114)
            moveButton(button: elbowSMButton, x: 42, y: 183)
        }
        else {
            showEverything()
            self.elbowLabel.layer.maskedCorners = [.layerMaxXMinYCorner, .layerMinXMinYCorner]
    ...
    @IBAction func showMoreHip(_ sender: Any) {
        if hipGraph.isHidden {
            ...
            moveLabel(label: hipLabel, x: 42, y: 68)
            moveLabel(label: hipLabelLong, x: 42, y: 114)
            moveButton(button: hipSMButton, x: 42, y: 183)
        }
        else {
            showEverything()
            self.hipLabel.layer.maskedCorners = [.layerMaxXMinYCorner, .layerMinXMinYCorner]
  ...
  private func detectPose(in image: MLImage, width: CGFloat, height: CGFloat) {
    if let poseDetector = self.poseDetector {
      ...
      DispatchQueue.main.sync {
        guard let strongSelf = weakSelf else {
          ...
          let poseOverlayView = UIUtilities.createPoseOverlayView(
            ...
            if showPipeline {
                        ...
                        //pipeline graph
                        let legsPPPoints = [NSValue(cgPoint: CGPoint(x: 42+388, y: 200+818)),
                                                NSValue(cgPoint: CGPoint(x: 42+388, y: 100+818)),
                                                NSValue(cgPoint: CGPoint(x: 150+388, y: 100+818)),
                                                NSValue(cgPoint: CGPoint(x: 190+388, y: 150+818)),
                                                NSValue(cgPoint: CGPoint(x: 150+388, y: 200+818))]
                        let bodyPPPoints = [NSValue(cgPoint: CGPoint(x: 150+388, y: 200+818)),
                                                NSValue(cgPoint: CGPoint(x: 190+388, y: 150+818)),
                                                NSValue(cgPoint: CGPoint(x: 150+388, y: 100+818)),
                                                NSValue(cgPoint: CGPoint(x: 258+388, y: 100+818)),
                                                NSValue(cgPoint: CGPoint(x: 298+388, y: 150+818)),
                                                NSValue(cgPoint: CGPoint(x: 258+388, y: 200+818))]
                        let armsPPPoints = [NSValue(cgPoint: CGPoint(x: 258+388, y: 200+818)),
                                                NSValue(cgPoint: CGPoint(x: 298+388, y: 150+818)),
                                                NSValue(cgPoint: CGPoint(x: 258+388, y: 100+818)),
                                                NSValue(cgPoint: CGPoint(x: 386+388, y: 100+818)),
                                                NSValue(cgPoint: CGPoint(x: 386+388, y: 200+818))]
                        ...
                        UIUtilities.addLabel(atPoint: CGPoint(x:111+388, y:150+818), to: poseOverlayView, color: UIColor.black, text: "Legs", width: 50, bgColor: .clear)
                        UIUtilities.addLabel(atPoint: CGPoint(x:234+388, y:150+818), to: poseOverlayView, color: UIColor.black, text: "Body", width: 50, bgColor: .clear)
                        UIUtilities.addLabel(atPoint: CGPoint(x:340+388, y:150+818), to: poseOverlayView, color: UIColor.black, text: "Arms", width: 50, bgColor: .clear)

              
              if(!isGrowing){
                  //print(legsAngle)
                  if legsAngle <= 90 {
                      let firstleginterval = ((legsAngle - currMinLegsAngle) / (90 - currMinLegsAngle)) * 108
                      UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 42+388, y: 200+818)),
                                                    NSValue(cgPoint: CGPoint(x: 42+388, y: 100+818)),
                                                        NSValue(cgPoint: CGPoint(x: 42+388 + firstleginterval, y: 100+818)),
                                                    NSValue(cgPoint: CGPoint(x: 42+388 + firstleginterval, y: 200+818))], to: poseOverlayView, color: UIColor(red:0.0/255.0, green:90.0/255.0, blue:181.0/255.0, alpha:1.0))
                  }
                  else{
                      let leginterval = ((legsAngle - 90) / (180 - 90)) * 40
                      ...
                      if (bodyinterval + 150 > leginterval + 150){
                          var arminterval = ((180 - elbowAngle) / (180 - currMinElbowAngle)) * 128
                          if arminterval > 128 {
                              arminterval = 128
                          }
                          //anche qui
                          if (arminterval + 258 > bodyinterval + 150) && (bodyinterval + 150 > 258) {
                              UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 42+388, y: 200+818)),
                                                        NSValue(cgPoint: CGPoint(x: 42+388, y: 100+818)),
                                                        NSValue(cgPoint: CGPoint(x: 258+388 + arminterval, y: 100+818)),
                                                                NSValue(cgPoint: CGPoint(x: 258+388 + arminterval, y: 200+818))], to: poseOverlayView, color: UIColor(red:0.0/255.0, green:90.0/255.0, blue:181.0/255.0, alpha:1.0))
                          }
                          else{
                              UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 42+388, y: 200+818)),
                                                        NSValue(cgPoint: CGPoint(x: 42+388, y: 100+818)),
                                                        NSValue(cgPoint: CGPoint(x: 150+388 + bodyinterval, y: 100+818)),
                                                            NSValue(cgPoint: CGPoint(x: 150+388 + bodyinterval, y: 200+818))], to: poseOverlayView, color: UIColor(red:0.0/255.0, green:90.0/255.0, blue:181.0/255.0, alpha:1.0))
                          }
                      }
                      else{
                          UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 42+388, y: 200+818)),
                                                    NSValue(cgPoint: CGPoint(x: 42+388, y: 100+818)),
                                                    NSValue(cgPoint: CGPoint(x: 150+388 + leginterval, y: 100+818)),
                                                        NSValue(cgPoint: CGPoint(x: 150+388 + leginterval, y: 200+818))], to: poseOverlayView, color: UIColor(red:0.0/255.0, green:90.0/255.0, blue:181.0/255.0, alpha:1.0))
                      }
              ...
              if flagPoint3 {
                  /*
        UIUtilities.addCircle(atPoint: CGPoint(x: strongSelf.normalizedPoint(fromVisionPoint: rightWrist.position, width: width, height: height).x, y: strongSelf.normalizedPoint(fromVisionPoint: rightWrist.position, width: width, height: height).y), to: ellipseOverlayView, color: UIColor.black, radius: 5.0)
                  ...
                  let sumDistancesArray = ellipseDistances.reduce(0, +)
                      ...
                      if avgArrayValue > maxAverageValue{
                          maxAverageValue = avgArrayValue
                      }
                     avgArrayValue = avgArrayValue/maxAverageValue * 10
                      ...
                      if avgArrayValue < 2.0{
                          lineColor = UIColor(red:255.0/255.0, green:255.0/255.0, blue:178.0/255.0, alpha:1)
                      }
                      if avgArrayValue >= 2.0 && avgArrayValue < 4.0{
                          lineColor = UIColor(red:254.0/255.0, green:204.0/255.0, blue:92.0/255.0, alpha:1)
                      }
                      if avgArrayValue >= 4.0 && avgArrayValue < 6.0{
                          lineColor = UIColor(red:253.0/255.0, green:141.0/255.0, blue:60.0/255.0, alpha:1)
                      }
                      if avgArrayValue >= 6.0 && avgArrayValue < 8.0{
                          lineColor = UIColor(red:240.0/255.0, green:59.0/255.0, blue:32.0/255.0, alpha:1)
                      }
                      if avgArrayValue >= 8.0 && avgArrayValue <= 10.0{
                          lineColor = UIColor(red:189.0/255.0, green:0.0/255.0, blue:38.0/255.0, alpha:1)
                      }*/
            ...
            // Displaying arc on elbow angle in red if wrong, green if right
              ...
              if !isGrowing && legsAngle < 120 && elbowAngle < 155 {
                  ...
                  if showPipeline {
                      ...
                      if arminterval >= 40 {
                      UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 258+388, y: 200+818)),
                                                        NSValue(cgPoint: CGPoint(x: 298+388, y: 150+818)),
                                                        NSValue(cgPoint: CGPoint(x: 258+388, y: 100+818)),
                                                        NSValue(cgPoint: CGPoint(x: 258+388 + arminterval, y: 100+818)),
                                                        NSValue(cgPoint: CGPoint(x: 258+388 + arminterval, y: 200+818))], to: poseOverlayView, color: UIColor(red:220.0/255.0, green:50.0/255.0, blue:32.0/255.0, alpha:1.0))
                      }
                      else{
                          let yintersection = 1.25*(258 + arminterval) - 222.5
                          UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 258+388, y: 200+818)),
                                                            NSValue(cgPoint: CGPoint(x: 258+388 + arminterval, y: 200+818)),
                                                            NSValue(cgPoint: CGPoint(x: 258+388 + arminterval, y: yintersection+818 + 2*(150 - yintersection)))], to: poseOverlayView, color: UIColor(red:220.0/255.0, green:50.0/255.0, blue:32.0/255.0, alpha:1.0))
                          UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 258+388, y: 100+818)),
                                                            NSValue(cgPoint: CGPoint(x: 258+388 + arminterval, y: 100+818)),
                                                            NSValue(cgPoint: CGPoint(x: 258+388 + arminterval, y: yintersection+818))], to: poseOverlayView, color: UIColor(red:220.0/255.0, green:50.0/255.0, blue:32.0/255.0, alpha:1.0))
                      }
                  }
              }
              ...
              { if(bodyAngle - currMinBodyAngle > 10) {
                  //Exlamation Mark
            ...
            //UIUtilities.addCircle(atPoint: CGPoint(x: previewLayer.layerPointConverted(fromCaptureDevicePoint: CGPoint(x: newShoulderPointx, y: newShoulderPointy)).x, y: previewLayer.layerPointConverted(fromCaptureDevicePoint: CGPoint(x: newShoulderPointx, y: newShoulderPointy)).y), to: poseOverlayView, color: UIColor.blue, radius: 50.0)
             ...
             flagPoint2 = true
              ...
              if (flagPoint && flagPoint2 && !isGrowing && showHip ){
              ...
              if showPipeline {
                  ...
                  if legsAngle < 90 {
                      ...
                      if bodyinterval >= 40 {
                      UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 150+388, y: 200+818)),
                                                        NSValue(cgPoint: CGPoint(x: 190+388, y: 150+818)),
                                                        NSValue(cgPoint: CGPoint(x: 150+388, y: 100+818)),
                                                        NSValue(cgPoint: CGPoint(x: 150+388 + bodyinterval, y: 100+818)),
                                                        NSValue(cgPoint: CGPoint(x: 150+388 + bodyinterval, y: 200+818))], to: poseOverlayView, color: UIColor(red:220.0/255.0, green:50.0/255.0, blue:32.0/255.0, alpha:1.0))
                      }
                      else{
                          let yintersection = 1.25*(150 + bodyinterval) - 87.5
                          UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 150+388, y: 200+818)),
                                                            NSValue(cgPoint: CGPoint(x: 150+388 + bodyinterval, y: 200+818)),
                                                            NSValue(cgPoint: CGPoint(x: 150+388 + bodyinterval, y: yintersection+818 + 2*(150 - yintersection)))], to: poseOverlayView, color: UIColor(red:220.0/255.0, green:50.0/255.0, blue:32.0/255.0, alpha:1.0))
                          UIUtilities.addShape(withPoints: [NSValue(cgPoint: CGPoint(x: 150+388, y: 100+818)),
                                                            NSValue(cgPoint: CGPoint(x: 150+388 + bodyinterval, y: 100+818)),
                                                            NSValue(cgPoint: CGPoint(x: 150+388 + bodyinterval, y: yintersection+818))], to: poseOverlayView, color: UIColor(red:220.0/255.0, green:50.0/255.0, blue:32.0/255.0, alpha:1.0))
                      }
                  }
              }
            ...
            //UIUtilities.addLabel(atPoint: strongSelf.normalizedPoint(fromVisionPoint: rightHip.position, width: width, height: height), to: poseOverlayView, color: UIColor.blue, text: Int(bodyAngleApprox).description, width: 50)
             ...
             self.maxAngleLabel.backgroundColor = .clear
              ...
              UIUtilities.addPieChart(to: poseOverlayView, startingAt: 0, endingAt: currMaxBodyAngle/3.60, radius: radius, fillColor: UIColor(red: 0.63, green: 0.87, blue: 0.85, alpha: 1), strokeColor: UIColor(red: 0.0, green: 0.66, blue: 0.62, alpha: 1), strokeSize: 2.0, rect: CGRect(x: xRect, y: yRect, width: sizeRect, height: sizeRect - 20), center: CGPoint(x: sizeRect/2, y: sizeRect/2 + 40), bgColor: UIColor(red:255.0/255.0, green:255.0/255.0, blue:255.0/255.0, alpha:0.9), mirror: mirror)
               if currMaxBodyAngle >= prevMaxBodyAngle{
                   UIUtilities.addPieChart(to: poseOverlayView, startingAt: prevMaxBodyAngle/3.60, endingAt: currMaxBodyAngle/3.60, radius: radius, fillColor: UIColor(red: 0.0, green: 0.66, blue: 0.62, alpha: 1), strokeColor: .clear, strokeSize: 0.0, rect: CGRect(x: xRect, y: yRect, width: sizeRect, height: sizeRect - 20), center: CGPoint(x: sizeRect/2, y: sizeRect/2 + 40), bgColor: .clear, mirror: mirror)
               }
              else{
                   UIUtilities.addPieChart(to: poseOverlayView, startingAt: currMaxBodyAngle/3.60, endingAt: prevMaxBodyAngle/3.60, radius: radius, fillColor: .gray, strokeColor: .clear, strokeSize: 0.0, rect: CGRect(x: xRect, y: yRect, width: sizeRect, height: sizeRect - 20), center: CGPoint(x: sizeRect/2, y: sizeRect/2 + 40), bgColor: .clear, mirror: mirror)
               }
               UIUtilities.addPieChart(to: poseOverlayView, startingAt: 0, endingAt: currMaxBodyAngle/3.60, radius: 30, fillColor: .clear, strokeColor: .black.withAlphaComponent(0.5), strokeSize: 1.0, rect: CGRect(x: xRect, y: yRect, width: sizeRect, height: sizeRect - 20), center: CGPoint(x: sizeRect/2, y: sizeRect/2 + 40), bgColor: .clear, mirror: mirror)
               
              
              UIUtilities.addLabel(atPoint: CGPoint(x: 140.0, y: 190.0), to: poseOverlayView, color: .black, text: Int(currMaxBodyAngle).description + "°", width: 50, bgColor: .clear)
              }
            ...
            if (legsAngle > 160 && bodyAngle > 90 && bodyAngle < 150) {
                //End of stroke
                if isStart && elapsedTime > 1 && elapsedTime < 10{
                    strokeCount += 1
            ...
            if(elbowAngle - 10 > previousElbowAngle && !isGrowing){
                print("ENTRA1")
            ...
            if(legsAngle - 5 > previousLegsAngle && isGrowing && strongSelf.normalizedPoint(fromVisionPoint: rightWrist.position, width: width, height: height).x < previuosWrist2){
                print("ENTRA2")
                isGrowing = false
        ...
        //if flagPoint3 {strongSelf.annotationOverlayView.addSubview(ellipseOverlayView)}
