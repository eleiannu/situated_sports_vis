...
public class UIUtilities {
  ...
  public static func addLabel(
    ...
    label.text = Int(text).description
  ...
  public static func createPoseOverlayView(
    ...
    for (startLandmarkType, endLandmarkTypesArray) in UIUtilities.poseConnections() {
      ...
      //print(pose.landmark(ofType: PoseLandmarkType.rightHip).position.x)
    ...
    let legsAngle : CGFloat = UIUtilities.angle(firstLandmark: pose.landmark(ofType: PoseLandmarkType.rightHip), midLandmark: pose.landmark(ofType: PoseLandmarkType.rightKnee), lastLandmark: pose.landmark(ofType: PoseLandmarkType.rightAnkle))
    
    let bodyAngle : CGFloat = UIUtilities.angle(firstLandmark: pose.landmark(ofType: PoseLandmarkType.rightShoulder), midLandmark: pose.landmark(ofType: PoseLandmarkType.rightHip), lastLandmark: pose.landmark(ofType: PoseLandmarkType.rightKnee))

    UIUtilities.addLabel(atPoint: positionTransformationClosure(pose.landmark(ofType: PoseLandmarkType.rightKnee).position), to: overlayView, color: UIColor.blue, text: legsAngle)
      
    UIUtilities.addLabel(atPoint: positionTransformationClosure(pose.landmark(ofType: PoseLandmarkType.rightHip).position), to: overlayView, color: UIColor.blue, text: bodyAngle)
